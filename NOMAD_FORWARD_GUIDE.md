...
6. Forensic legacy-residue audit and cleanup log:
   - `/Users/jracine/Development/crs/archive/ROOT_MD_CLOSEOUT_20260313/NOMAD_FORENSIC_AUDIT.md`
...
6. Path defaults currently applied unless user overrides:
   ...
   - `crs.formula` wrapper default evaluation budget is also `max.bb.eval=140` (aligned with `krscvNOMAD`)

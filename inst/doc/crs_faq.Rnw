%% $Id: crs_faq.tex,v 1.27 2012/03/25 20:58:55 jracine Exp jracine $
...
is 0.15-16. Kindly update your version should you not be using the most
...
To cite package `crs' in publications use:
  ...
  <niez@mcmaster.ca> (2011). crs: Categorical Regression Splines. R
...
A BibTeX entry for LaTeX users is
  ...
  @Manual{,
    ...
    year = {2012},
    note = {R package version 0.15-16},
  }
\end{verbatim}
  \end{singlespacing}

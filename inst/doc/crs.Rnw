...
\citeauthor{MA_RACINE:2011} \citeyear{MA_RACINE:2011} when the option
...
\begin{equation*}
  l(Z^d_{is},z^d_s,\lambda_s) = \lambda_s^{|Z_{is}^d-z^d_s| }
\end{equation*}
and modify the product kernel function appropriately.

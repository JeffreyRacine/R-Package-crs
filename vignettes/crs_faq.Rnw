%% $Id: crs_faq.tex,v 1.36 2016/05/23 13:09:06 jracine Exp jracine $
...
is 0.15-24. Kindly update your version should you not be using the
...
To cite package `crs' in publications use:
  ...
  Regression Splines. R package version 0.15-24.
...
\section*{Changes from Version 0.15-24 to 0.15-25 [20-Apr-2017]}

\begin{itemize}

\item Fixed glitch that could arise when computing derivatives and
  multiple predictors have degree 0 when using glp basis

...
is 0.15-29. Kindly update your version should you not be using the
...
\item Fixed issue pointed out by Brian Ripley (thanks!) about \texttt{double ** \_X} in the nomad code

...
is 0.15-39. Kindly update your version should you not be using the
...
See
\href{https://cran.r-project.org/web/views/Econometrics.html}{cran.r-project.org/web/views/Econometrics.html} for further information.
...
\subsection{I noticed you have placed a new version of the \texttt{crs}
  ...
  (\url{https://cran.r-project.org/web/packages/crs/ChangeLog}), or go

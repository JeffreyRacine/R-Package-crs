%% $Id: crs_faq.tex,v 1.31 2013/12/30 12:10:21 jracine Exp jracine $
...
is 0.15-19. Kindly update your version should you not be using the most
...
To cite package `crs' in publications use:
  ...
  Jeffrey S. Racine and Zhenghua Nie (2013). crs: Categorical
  Regression Splines. R package version 0.15-19.
...
A BibTeX entry for LaTeX users is
  ...
  @Manual{,
    ...
    year = {2013},
    note = {R package version 0.15-19},

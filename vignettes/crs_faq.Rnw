%% $Id: crs_faq.tex,v 1.33 2014/01/21 15:54:18 jracine Exp jracine $
...
is 0.15-21. Kindly update your version should you not be using the
...
To cite package `crs' in publications use:
  ...
  Regression Splines. R package version 0.15-21.
...
A BibTeX entry for LaTeX users is
  ...
  @Manual{,
    ...
    year = {2014},
    note = {R package version 0.15-21},
...
\texttt{opts=list("DISPLAY_DEGREE"=0)} (see \texttt{?snomadr} for
details).

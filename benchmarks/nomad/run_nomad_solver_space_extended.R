...
out_prefix <- if (length(args) >= 1) args[[1]] else "/tmp/crs_nomad_solver_space_ext"
...
strategies <- list(
  frscvNOMAD = list(
    ...
    fr_spec_off = list(nmulti = 2L, max_bb_eval = 100L, opts = list("SPECULATIVE_SEARCH" = "no")),
    fr_nm_search_off = list(nmulti = 2L, max_bb_eval = 100L, opts = list("NM_SEARCH" = "no")),
    fr_simple_line = list(nmulti = 2L, max_bb_eval = 100L, opts = list("SIMPLE_LINE_SEARCH" = "yes", "SPECULATIVE_SEARCH" = "no")),
    fr_vns_search = list(nmulti = 2L, max_bb_eval = 100L, opts = list("VNS_MADS_SEARCH" = "yes", "VNS_MADS_SEARCH_TRIGGER" = 0.60)),
  ...
  krscvNOMAD = list(
    ...
    kr_nm_search_off = list(nmulti = 2L, max_bb_eval = 100L, opts = list("NM_SEARCH" = "no")),
    kr_simple_line = list(nmulti = 2L, max_bb_eval = 100L, opts = list("SIMPLE_LINE_SEARCH" = "yes", "SPECULATIVE_SEARCH" = "no")),
    kr_vns_search = list(nmulti = 2L, max_bb_eval = 100L, opts = list("VNS_MADS_SEARCH" = "yes", "VNS_MADS_SEARCH_TRIGGER" = 0.60)),

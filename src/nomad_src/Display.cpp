...
std::ostream & NOMAD::operator << ( std::ostream & out , NOMAD::search_type st )
{
    switch ( st )
    {
        ...
        case NOMAD::ASYNCHRONOUS:
            ...
            break;
        case NOMAD::TRENDMATRIX_LINE_SEARCH:
            out << "Trend matrix basic line search";
            break;
        case NOMAD::NM_SEARCH:
            out << "Nelder Mead search";
            break;
                                   ...
                                   NOMAD::direction_type   dt    )
{
    switch ( dt )
    {
        ...
        case NOMAD::NO_DIRECTION:
            out << "none";
            break;
        case NOMAD::INT_POLL_DIR:
            out << "Intensification poll direction";
            break;
        case NOMAD::MODEL_SEARCH_DIR:
            out << "model search direction";
            break;
        case NOMAD::NELDERMEAD_SEARCH_DIR:
            out << "Nelder Mead search direction";
            break;
        case NOMAD::TRENDMATRIX_SEARCH_DIR:
            out << "Trend matrix line search direction";
            break;
